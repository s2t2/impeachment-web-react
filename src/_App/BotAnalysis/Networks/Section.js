        ...
        <Container fluid>
            <Card>
                <Card.Body>
                    ...
                    <Card.Text>
                        We filtered out bots who weren't similar to any others,
                        {" "} and grouped the remaining 681 bots into a given number of clusters,
                        {" "} using a <a href="https://scikit-learn.org/stable/modules/generated/sklearn.cluster.SpectralClustering.html">Spectral Clustering</a> method (similar to K-Means Clustering).
                        {" "} We chose two clusters &mdash; to reflect the bipartisan nature of US politics.
                    ...
                    <Card.Text>
                    */}
                        {" "} Based on the retweet beneficiaries and language patterns of each community, we observe
                        {" "} Community 0 represents anti-Trump bots, and
                        {" "} Community 1 represents pro-Trump bots.
                    </Card.Text>


                    <h4 id="sentiment-hashtags">Sentiment Hashtags</h4>
                    <Card.Text>
                        We identified the top hashtags used by each of these bot retweet communities,

                        {" "} then removed shared topics like <i>'#Impeachment'</i> and <i>'#FactsMatter'</i>, which were used by both communities.
