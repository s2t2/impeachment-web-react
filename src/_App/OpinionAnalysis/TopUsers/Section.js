        ...
        <Container fluid>
            <Card>
                <Card.Body>
                    ...
                    <Card.Text>
                        After <a href="/user-opinions">calculating mean opinion scores</a> for all users in our dataset, we are able to compare the user's scores relative to each other to see which are more pro-Trump vs anti-Trump.
